...
title ENTCare AI - Download Offline Packages
...
echo.
echo  ================================================================
echo   ENTCare AI  -  OFFLINE PACKAGE DOWNLOADER
echo  ================================================================
echo.
...
if "%PIP%"=="" (echo   [FAIL]  pip not found. Run START_ENTCare_AI.bat first. & pause & exit /b 1)
...
echo.
echo  ================================================================
echo   DONE. ENTCare AI now works WITHOUT internet connection.
echo   Run START_ENTCare_AI.bat to launch.
echo  ================================================================
echo.
pause
