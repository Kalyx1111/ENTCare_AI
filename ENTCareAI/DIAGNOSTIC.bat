...
echo.
echo  ================================================================
echo   ENTCare AI  -  FULL DIAGNOSTIC TOOL
echo  ================================================================
echo.
echo ENTCare AI Diagnostic > "%RPT%"
...
call :SEC "4. FILES"
for %%F in ("server.py" "static\index.html" "modules\ai_providers.py" "START_ENTCare_AI.bat") do (
...
if /i "%DC%"=="S" call "%BASEDIR%\START_ENTCare_AI.bat" & exit /b 0
if /i "%DC%"=="X" exit /b 0
goto :DM
:SEC
